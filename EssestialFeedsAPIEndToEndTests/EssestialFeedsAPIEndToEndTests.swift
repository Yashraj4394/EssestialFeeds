//
//  EssestialFeedsAPIEndToEndTests.swift
//  EssestialFeedsAPIEndToEndTests
//
//  Created by YashraJ Gujar on 28/03/22.
//

import XCTest
import EssestialFeeds

class EssestialFeedsAPIEndToEndTests: XCTestCase {
	
	func test_EndToEndTestServerGETFeedResult_matchesFixedTestAccountData(){
		switch getFeedResult() {
				
			case .success(let imageFeed):
				XCTAssertEqual(imageFeed.count, 8,"Expected 8 images in the test accoount image feed")
			...
			default:
				XCTFail("Expeccted successful feed result , got no result instead")
		}
	}
