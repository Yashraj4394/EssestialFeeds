...
class RemoteFeedLoaderTests: XCTestCase {
	...
	func test_load_deliversItemsOn200HTTPResponseWithJSOnItems(){
		...
		let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "https://www.a-url.com")!)
		...
		let item2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "https://www.a-new-url.com")!)
